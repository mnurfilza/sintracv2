        ...
        <div class="row">
          <div class="col-md-6 col-lg-4">
            <div class="box ">
              ...
              <div class="detail-box">
                ...
                <p>
                  Procurement of new units (Genset, Forklift, Reach TruckTowing, Handpallet, Stacker, etc),
                  Used Equipment (Sales & Trade-in) and Rental
                </p>
          ...
          <div class="col-md-6 col-lg-4">
            <div class="box ">
              ...
              <div class="detail-box">
                <h5>
                  Part and Service (All Brand)
                </h5>
                <p>
                  Supply spareparts material handling and power generating and heavy equipment and
          ...
          <div class="col-md-6 col-lg-4">
            <div class="box ">
              ...
              <div class="detail-box">
                ...
                <p>
                  Mechanical & Electrical,Construction and Civil Engineering
                </p>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="detail-box">
            ...
            <p class="lh-sm">
              Menjadi perusahaan perdagangan dan jasa yang amanah, cepat, tangkas,
              dan kompetitif yang mampu memberikan solusi bisnis dan membantu
            ...
            <p class="lh-sm text-justify">
              Memberikan produk berkualitas dengan harga kompetitif dan 
              bermanfaat demi memastikan kepuasan pelanggan dan 
            ...
            <p class="lh-sm text-justify">
              Memperkuat kolaborasi dan kerjasama yang saling menguntungkan dengan
              produsen, dealer utama , supplier dan konsumen melalui komunikasi dan
      ...
      <div class="carousel-wrap ">
        <div class="filter_box">
          ...
          <nav class="owl-filter-bar">
            ...
            <a href="#" class="item" data-owl-filter=".pompa">Compressor</a>
          </nav>
        </div>
