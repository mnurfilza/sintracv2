...
<div class="">
    ...
    <div class="row bg-product rounded-3 position-relative">
      <div class="container py-5">
          <div class="row">
              <div class="col-md-12 d-flex flex-column justify-content-center align-items-center bg-image py-4">
...
<div class="container mb-5">
  <div class="row g-4">
    @foreach ($subCategory['sub_category'] as $card)
          <div class="col-lg-4 col-md-6 col-sm-12">
              <div class="card h-100">
                  <img src="{{ asset('assets/img/'.$card['thumbnail']) }}" class="card-img-top img-fluid" alt="{{ $card['title'] }}">
                  <div class="card-body">
                      <h5 class="card-title">{{ $card['title'] }}</h5>
                      <p class="card-text">{{ $card['text'] }}</p>
                      <a href="/products/brand/{{ $card['id'] }}" class="btn btn-primary w-100">Go somewhere</a>
                  </div>
              </div>
          </div>
          @endforeach
